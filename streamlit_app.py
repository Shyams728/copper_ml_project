...
from copper_ml.config import PROCESSED_DATA_PATH
...
if page == "Home":
    ...
    with col2:
        st.image("assets/shubham-dhage-AC4Q1uLRKd4-unsplash.jpg",
...
# --- EDA DASHBOARD ---
    ...
    if df is not None:
        ...
        st.warning(
            ...
            "`data/processed/cleaned_copper_data.csv` or upload data."
        )
